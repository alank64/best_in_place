...
//          console.log("Hello???");
//          console.log(val);
//          //this.element.find("input:hidden")this.element.find("input").data().select2.container[0].textContent
//          //that.update();
//        }
    ...
    getValue :  function() {
      ...
      //console.log(this.element.find("input:hidden").val());
      //console.log("getValue: data() : ");
      //console.log(this.element.find("input:hidden").data().select2.container[0].textContent);
      //return this.sanitizeValue(this.element.find("input").data().select2.container[0].textContent);
